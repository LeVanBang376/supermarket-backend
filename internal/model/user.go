...
type User struct {
	...
	RoleID       string    `gorm:"column:role_id;type:varchar(20);not null" json:"role_id"`
	PositionID   string    `gorm:"column:position_id;type:varchar(5);not null" json:"position_id"`
